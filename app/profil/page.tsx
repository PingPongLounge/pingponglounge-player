  ...
  if(error) return(
    <main style={{minHeight:"100vh",background:BG,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"20px"}}>
      <div style={{textAlign:"center"}}>
        ...
        <button onClick={load} style={{...btn,display:"inline-block",padding:"10px 24px",fontSize:13,fontFamily:"inherit"}}>Nochmals versuchen</button>
      </div>
      <BottomNav />
    </main>
  )
      ...
      <div style={{maxWidth:560,margin:"0 auto"}}>
        ...
        <div style={{textAlign:"center",margin:"24px 0 28px"}}>
          ...
          <Link href="/profil/avatar" style={{display:"inline-block",position:"relative",marginBottom:12}}>
            <div style={{width:80,height:80,borderRadius:"50%",background:CELL,overflow:"hidden",display:"flex",alignItems:"center",justifyContent:"center",fontSize:32}}>
              {profile.avatar_url
        ...
        <div style={{...card,marginBottom:10}}>
          <div style={{padding:"14px 18px",borderBottom:`1px solid rgba(255,255,255,.06)`,display:"flex",alignItems:"center",position:"relative"}}>
        ...
        {/* Logout */}
        <div style={{...card,marginTop:8,borderRadius:14,padding:"14px 18px",display:"flex",alignItems:"center",gap:12}}>
          <div style={{width:38,height:38,borderRadius:10,background:CELL,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18}}>🚪</div>
