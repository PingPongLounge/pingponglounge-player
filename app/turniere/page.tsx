  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0A0A0C', padding: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '56px', fontWeight: 900, textTransform: 'uppercase', color: '#FFF9F3', marginBottom: '16px' }}>TURNIERE</h1>
        <p style={{ fontSize: '15px', color: '#6B6E7A' }}>Community Turniere, Gruppenphase, QR-Resultate</p>
      </div>
    </main>
  )
}
