  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: DARK, padding: "20px" }}>
      <div style={{ maxWidth: "380px", width: "100%", textAlign: "center" }}>
        ...
        {/* Google */}
        <button onClick={signInWithGoogle} style={ghostBtn}>
        ...
        {msg ? (
          ...
          <form
            onSubmit={tab === "login" ? handleLogin : tab === "register" ? handleRegister : tab === "magic" ? handleMagic : handleReset}
            style={{ display: "flex", flexDirection: "column", gap: "10px" }}
          >
            <input type="email" value={email} onChange={e => setEmail(e.target.value)}
              placeholder="deine@email.ch" required style={input} />
