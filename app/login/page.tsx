      ...
      <div style={{ maxWidth: "360px", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", gap: "0" }}>
        ...
        {sent ? (
          ...
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "10px", width: "100%" }}>
            ...
            <button type="submit" disabled={loading} style={{ width: "100%", background: G, color: "#0A0A0C", border: "none", borderRadius: "10px", padding: "15px", fontSize: "14px", fontWeight: 700, cursor: "pointer", textTransform: "uppercase" as const, letterSpacing: "0.06em", fontFamily: "inherit" }}>
