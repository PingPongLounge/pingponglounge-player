...
export default async function Dashboard() {
  ...
  const liveCards = [
    ...
    {
      href: '/freunde', label: 'Freunde werben', sub: '2 Gratisstunden pro Einladung', color: G,
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={G} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
    },
    {
      href: '/stunden', label: 'Meine Stunden', sub: 'Gratisstunden · Einlösen', color: G,
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={G} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></svg>
    },
    {
  ...
  return (
    <main style={{ minHeight: '100vh', background: DARK, padding: '0 0 40px' }}>
      ...
      <header style={{ padding: '20px 20px 0', display: 'grid', gridTemplateColumns: '1fr auto 1fr', alignItems: 'center', maxWidth: '700px', margin: '0 auto' }}>
        <div />
        <Link href="/dashboard" style={{ display: 'flex', textDecoration: 'none' }}><PlayerLogo size="sm" /></Link>
