      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <svg viewBox="0 0 360 80" fill="none" style={{ width: '120px', height: 'auto', margin: '0 auto 20px' }}>
            <defs><linearGradient id="rpg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#FF00C8"/><stop offset="1" stopColor="#FF5CDC"/></linearGradient></defs>
            ...
            <text x="76" y="66" fontFamily="var(--font-anton), Impact, sans-serif" fontSize="58" fontWeight="900" letterSpacing="2" fill="none" stroke="url(#rpg)" strokeWidth="2.2" paintOrder="stroke">PLAYER</text>
          </svg>
