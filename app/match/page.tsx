  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0A0A0C', padding: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '48px', fontWeight: 900, textTransform: 'uppercase', color: '#FFF9F3', marginBottom: '16px' }}>FIND A MATCH</h1>
        <p style={{ fontSize: '15px', color: '#6B6E7A' }}>Spontan mitspielen, passende Gegner finden</p>
      </div>
    </main>
  )
}
